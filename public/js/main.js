...
portfolioInfo = document.getElementById('portfolio-info');

function showPortfolioInfo()
{  
  document.getElementById('portfolio-info').style.opacity = "1";
  document.getElementById('portfolio-info').style.zIndex = "2";
  document.getElementById('portfolio-info').style.pointerEvents = "all";
}

function hidePortfolioInfo()
{
  document.getElementById('portfolio-info').style.opacity = "0";
  document.getElementById('portfolio-info').style.zIndex = "0";
  document.getElementById('portfolio-info').style.pointerEvents = "none";
}
...
// let workContent = document.getElementsByClassName("work-content");
