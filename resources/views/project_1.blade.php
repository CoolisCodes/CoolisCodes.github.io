  ...
  <div class="intro intro-single route bg-image" style="background-image: url({{ asset('img/overlay-bg.jpg')}})">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h2 class="intro-title mb-4">XR Active Learning</h2>
    ...
    <section class="portfolio-details">
      <div class="container">
        ...
        <div class="portfolio-description">
          ...
          <p>
            A new possibility and opportunity for learning and training.
            “<b>XR Active Learning</b>” brings the best results and efficiency in the “cone of learning” for any trainee: Better retention, absorption, skills development, decreased training time, increased safety (no risk) and overall learning experience through gamification, personalization and actionable data.
            It is also scalable and deployable anywhere, anytime (using mainstream tech or/and specialized VR eqp). In or/and out of training facilities.
            At the same time existing training facilities and content are upgraded providing an enhanced experience to trainees making them better prepared.
            They also benefit from significantly increased capacity (since trainees need to spend less time in the real facility).
